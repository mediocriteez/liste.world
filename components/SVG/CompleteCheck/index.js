...
const CompleteCheck = ({complete = false, className = '', ...props}) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 25" className={`${css.root} ${className}`} {...props} data-complete={complete}>
